...
var funWebSvr = function (req, res){
    ...
    console.log("[WebSvr] Request type: " + req.method.toUpperCase());
...
//开始侦听8024端口
webSvr.listen(8024, function(){

    //向控制台输出服务启动的信息
    console.log('[WebSvr][Start] running at http://127.0.0.1:8024/');
...
var postHandler = function (req, res){
    ...
    req.addListener("data", function(pd) {
      post_data = String(pd);
...
//创建一个http服务器
var postHandlerSrv=libHttp.createServer(postHandler);

//指定服务器错误事件响应
postHandlerSrv.on("error", function(error) {
  console.log(error);  //在控制台中输出错误信息
});


//开始侦听8888端口
postHandlerSrv.listen(8888, function(){
